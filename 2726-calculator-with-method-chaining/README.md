...
<ul>
	...
	<li><code>divide</code> -&nbsp;This method divides the <code>result</code> by the given number <code>value</code> and returns the updated <code>Calculator</code>. If the passed value is <code>0</code>, an error <code data-sider-select-id="7e97907f-f2af-4f0e-b7d1-d618146597ad">"Division by zero is not allowed"</code> should be thrown.</li>
