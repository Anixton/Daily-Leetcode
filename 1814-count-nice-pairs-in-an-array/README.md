...
<p>Return <em>the number of nice pairs of indices</em>. Since that number can be too large, return it <strong>modulo</strong> <code data-sider-select-id="43ad9643-ffb1-4233-be97-1e1a94659838">10<sup>9</sup> + 7</code>.</p>

<p data-sider-select-id="bb822ea8-f01a-41e8-8163-b0799953f163">&nbsp;</p>
