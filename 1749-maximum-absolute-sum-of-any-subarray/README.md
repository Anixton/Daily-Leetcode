...
<pre data-sider-select-id="c957d271-a7f8-4250-87fe-cbde1cf685ed"><strong>Input:</strong> nums = [1,-3,2,3,-4]
...
<pre data-sider-select-id="09de19c7-aab1-4e67-862d-dc898e1f0244"><strong>Input:</strong> nums = [2,-5,1,-4,3,-2]
